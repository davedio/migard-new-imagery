---
name: midgard-design
description: Use this skill to generate well-branded interfaces and assets for Midgard, a Cardano-native Layer 2 optimistic rollup ("Built for Throughput. Secured by Math."), either for production or throwaway prototypes/mocks. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping in the Midgard "Dark Ancient Tech / Trust Architecture" style.
user-invocable: true
---
...
- **Production handoff:** `handoff/midgard-gateway/` — drop-in `.tsx` components + apply guides for the real Next.js repo.
...
**Brand essentials:** dark green-black surfaces (deep ink `#07120b`), Midgard green `#20be43` / bright `#3be863` for live/valid signals, gold `#b7791f`/`#e0a33c` for proof/settlement, Cardano-blue for L1 references. Syne display headings, JetBrains Mono for eyebrows/chips/metrics/CTAs. Glow not shadow; gold hairline on panels; status chips with dots; calm, exact, anti-hype copy; no emoji.
