...
// The home hero: a PHOTOREAL world-tree PLATE (hero-tree.jpg, tree offset
// RIGHT) with a calm ambient sap-orb overlay — consistent with the photoreal
// How-It-Works tree. The old StaticTreeHero (green PNG) and the procedural
// WorldTreeScene are retained as alternate forks via HERO_MODE.
//   "photoreal" — AI photoreal plate + ambient sap orbs (PhotorealHomeHero)
...
const HERO_MODE: "photoreal" | "static" | "three" = "photoreal";
...
const PhotorealHomeHero = dynamic(() => import("./scene/PhotorealHomeHero"), {
  ssr: false,
});
...
export default function GatewayPhotoreal() {
  ...
  return (
    <>
      <div className="scene-stage">
        {HERO_MODE === "photoreal" ? (
          <PhotorealHomeHero motionOn={motionOn} progressRef={progress} />
        ) : HERO_MODE === "three" ? (
      ...
      <main className="content">
        <Hero />
        {/* Body sections float OVER the still-visible plate as the tree scans
            canopy -> roots on scroll (CHANGE 3). The body is transparent with
