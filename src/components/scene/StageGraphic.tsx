...
const STAGES: Stage[] = [
  {
    ...
    tag: "Off-chain · L2",
    name: "Submit",
    line: "A transaction enters Midgard and is validated against eUTXO rules immediately, with no L1 block wait.",
    readouts: [
  ...
  },
  {
    ...
    tag: "L1 State Queue",
    name: "Commit",
    line: "The batcher posts a compact state commitment to L1, where it enters the on-chain state queue for anyone to inspect.",
    readouts: [
      { k: "Action", v: "Post commitment", tone: "bridge" },
      { k: "Anchor", v: "L1 queue", tone: "bridge" },
  ...
  },
  {
    ...
    tag: "L1 Confirmed",
    name: "Settle",
    line: "If no valid fault proof succeeds, the maturity period ends and the block merges into confirmed L1 state.",
    readouts: [
      { k: "Action", v: "Merge state", tone: "l1" },
      { k: "Anchor", v: "L1", tone: "l1" },
